...
- [cloudeteer/terraform-azurerm-vm](https://github.com/cloudeteer/terraform-azurerm-vm) ([v1.3.0](https://github.com/cloudeteer/terraform-azurerm-vm/releases/tag/v1.3.0), today) - ☁️ Cloudeteer&#39;s Terraform AzureRM virtual machine module
