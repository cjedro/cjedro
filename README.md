...
- [prometheus/alertmanager](https://github.com/prometheus/alertmanager) ([v0.33.0](https://github.com/prometheus/alertmanager/releases/tag/v0.33.0), 1 day ago) - Prometheus Alertmanager
- [cloudeteer/terraform-azurerm-vm](https://github.com/cloudeteer/terraform-azurerm-vm) ([v1.11.0](https://github.com/cloudeteer/terraform-azurerm-vm/releases/tag/v1.11.0), 3 days ago) - ☁️ Cloudeteer&#39;s Terraform AzureRM virtual machine module
...
- [feat: add possibility to set accelerated_networking_enabled and ip_forwarding_enabled in the network interface](https://github.com/cloudeteer/terraform-azurerm-vm/pull/99) on [cloudeteer/terraform-azurerm-vm](https://github.com/cloudeteer/terraform-azurerm-vm) (4 days ago)
- [fix: ignore changes of type_handler_version in azurerm_virtual_machine_extensions](https://github.com/cloudeteer/terraform-azurerm-vm/pull/98) on [cloudeteer/terraform-azurerm-vm](https://github.com/cloudeteer/terraform-azurerm-vm) (4 days ago)
