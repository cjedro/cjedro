...
- [webdevops/helm-azure-tpl](https://github.com/webdevops/helm-azure-tpl) ([0.61.0](https://github.com/webdevops/helm-azure-tpl/releases/tag/0.61.0), today) - Helm plugin and standalone tool for Azure - injecting Azure information and KeyVault secrets into files using go template engine
