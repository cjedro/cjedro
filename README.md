...
- [prometheus/alertmanager](https://github.com/prometheus/alertmanager) ([v0.34.0](https://github.com/prometheus/alertmanager/releases/tag/v0.34.0), 1 day ago) - Prometheus Alertmanager
- [cjedro/blink-snap](https://github.com/cjedro/blink-snap) ([v1.2.0](https://github.com/cjedro/blink-snap/releases/tag/v1.2.0), 3 days ago) - Vibecoded app that takes a picture from your blink camera and saves it locally.
...
- [add tests](https://github.com/cjedro/blink-snap/pull/18) on [cjedro/blink-snap](https://github.com/cjedro/blink-snap) (3 days ago)
...
- [Alishahryar1/free-claude-code](https://github.com/Alishahryar1/free-claude-code) - Use Claude Code, Codex, Pi, and OpenCode for free (1.3B&#43; free tokens) from your terminal, app, IDE, or phone like OpenClaw (voice supported &#43; ToS friendly) (2 months ago)
