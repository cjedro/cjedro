...
- [cjedro/blink-snap](https://github.com/cjedro/blink-snap) ([v1.1.0](https://github.com/cjedro/blink-snap/releases/tag/v1.1.0), 4 weeks ago) - Vibecoded app that takes a picture from your blink camera and saves it locally.
